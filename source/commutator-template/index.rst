...
-   To confirm proper function of the commutator by controlling it with Bonsai
    and key presses, refer to the :ref:`quick_start_:dry:`shorthand`` page.
-   To automate the commutator with orientation data from specific hardware such
    as `Miniscopes <https://open-ephys.org/miniscope-v4/miniscope-v4>`__ or
    `ONIX headstages
    <https://open-ephys.github.io/onix-docs/Hardware%20Guide/Headstages/headstage-64/index.html>`__, refer to the
    complete :ref:`user_guide_:dry:`shorthand``.
