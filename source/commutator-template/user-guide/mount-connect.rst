...
.. image:: ../../../source/_static/commutator-mounting-holes.png
    :alt: schematic image
    :align: center
...
.. figure:: ../../../source/_static/tether-drawing.png
    :alt: tether drawing
    :align: center
...
.. raw:: html
    ...
    <div class="container">
        ...
        <div class="row">
            <img src="../../../../source/_static/connections-numbered.png" alt="commutator connections image">
        </div>
        <div class="row">
...
..  Attention::
    ...
    *   For animal behavior experiments, manage the USB cable and the coaxial cable (between the commutator and DAQ)
    ...
    ..  image:: ../../../source/_static/commutator-cable-management.png
