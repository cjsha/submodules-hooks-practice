.. _manual_control_:dry:`shorthand`:

Manual Control
*******************************************************

The front panel of the commutator has four buttons for manual control. They are useful for situations such as:
...
..  note::  The buttons on the front panel are capacitive sensor buttons. They are not mechanical so they do not provide
            tactile or auditory feedback.

..  image:: ../../../source/_static/commutator-buttons-numbered.png
    :width: 50%
    :align: center
...
..  image:: ../../../source/_static/commutator-side-button-numbered.png
    :width: 50%
    :align: center
